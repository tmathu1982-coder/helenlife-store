...
async function getProductsFromLark() {
  try {
    ...
    const recordRes = await fetch(`https://open.larksuite.com/open-apis/bitable/v1/apps/${process.env.LARK_BASE_ID}/tables/${process.env.LARK_TABLE_ID}/records`, {
    ...
    <main className="min-h-screen bg-gray-50 text-gray-800 font-sans flex flex-col">
      ...
      <header className="bg-white text-green-900 sticky top-0 z-50 shadow-sm border-b-4 border-green-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <div className="flex items-center">
            <Image src="/logo-helenlife.png" alt="Helen Life Logo" width={160} height={50} className="object-contain" priority/>
          </div>
      ...
      <section id="ve-chung-toi" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto bg-green-50/50 p-8 md:p-12 rounded-3xl border border-green-100 mb-16 shadow-sm">
            <p className="font-bold text-gray-900 text-lg mb-6">Kính gửi Quý Đại lý, Đối tác và Quý Nhà nông,</p>
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              <p><strong className="text-green-800">HELEN LIFE</strong> được thành lập với định hướng trở thành đơn vị cung cấp các <strong className="text-green-700">giải pháp dinh dưỡng cây trồng toàn diện</strong>, kết nối những nhà máy sản xuất uy tín với hệ thống phân phối và người nông dân trên khắp Việt Nam.</p>
              <p>Chúng tôi lựa chọn hợp tác với các nhà máy có năng lực sản xuất, quy trình kiểm soát chất lượng nghiêm ngặt và sản phẩm đã được kiểm chứng trên thực tế. Mỗi sản phẩm trong danh mục đều được tuyển chọn nhằm mang đến <strong className="text-green-700">hiệu quả canh tác ổn định, góp phần cải tạo đất, nâng cao năng suất và phát triển nền nông nghiệp bền vững.</strong></p>
              <p>HELEN LIFE không chỉ phân phối sản phẩm, mà còn <strong className="text-green-700">đồng hành cùng khách hàng</strong> thông qua tư vấn kỹ thuật, xây dựng quy trình sử dụng phù hợp với từng loại cây trồng và từng điều kiện canh tác, hướng đến <strong className="text-green-700">hiệu quả kinh tế lâu dài.</strong></p>
            </div>
            <div className="mt-8 bg-white p-6 rounded-2xl flex items-start gap-4 border-l-4 border-green-600 shadow-sm">
              ...
              <p className="text-xl italic font-medium text-green-900 pt-1">"Đồng hành cùng nhà nông bằng những giải pháp thực tiễn, sản phẩm chất lượng và dịch vụ tận tâm."</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-green-100 text-center hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
              <div className="w-20 h-20 bg-green-50 text-green-700 rounded-full flex items-center justify-center mx-auto mb-6"><CheckCircle size={36} /></div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-green-100 text-center hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
              <div className="w-20 h-20 bg-green-50 text-green-700 rounded-full flex items-center justify-center mx-auto mb-6"><Settings size={36} /></div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-green-100 text-center hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
              <div className="w-20 h-20 bg-green-50 text-green-700 rounded-full flex items-center justify-center mx-auto mb-6"><Handshake size={36} /></div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-green-100 text-center hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
              <div className="w-20 h-20 bg-green-50 text-green-700 rounded-full flex items-center justify-center mx-auto mb-6"><TrendingUp size={36} /></div>
      ...
      <section id="san-pham" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-grow">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600">Dữ liệu được cập nhật tự động từ hệ thống quản lý trung tâm.</p>
          <div className="w-24 h-1.5 bg-green-600 mx-auto mt-6 rounded-full"></div>
        </div>

        {products.length === 0 ? (
           <p className="text-center text-gray-500 font-bold text-xl">Đang kết nối dữ liệu sản phẩm...</p>
        ) : (
